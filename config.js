...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "PESTCON (PTY) LTD",
    phone:     "+27 10 591 0587",
    whatsapp:  "+27 10 591 0587",
    address:   "49 10th St, Boksburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "PESTCON (PTY) LTD — Pest control in boksburg",
    description: "PESTCON (PTY) LTD provides professional pest control in Boksburg. 4 Google reviews. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Pest control · Boksburg & surrounds",
    heroTitle:  "Pest problem? <em>We sort it out properly.</em>",
    heroLead:   "PESTCON (PTY) LTD provides effective pest control for homes and businesses across Boksburg. Cockroaches, rodents, ants, termites — we identify the problem and treat it at the source.",
    ...
    band: {
      ...
      alt:   "PESTCON (PTY) LTD team at work in Boksburg",
      text:  "Effective pest control — we fix the problem, not just the symptoms."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Serving Boksburg and surrounds.",
    areasLead:  "We cover residential and commercial properties across Boksburg, Johannesburg, Randburg and the surrounding areas.",
